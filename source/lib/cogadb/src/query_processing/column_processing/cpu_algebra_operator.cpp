...
//	{
//		logical_operator::Logical_CPU_ColumnAlgebraOperation&
// log_algebra_ref =
// static_cast<logical_operator::Logical_CPU_ColumnAlgebraOperation&>(logical_node);
//		if(!quiet && debug && verbose) std::cout << "create
// CPU_Columnalgebra_Operator!" << std::endl;
//		if(!left_child) {
//			std::cout << "[HyPE Library]: Fatal Error! in
// query_processing::physical_operator::create_CPU_ColumnAlgebraOperator()" <<
// std::endl;
//			std::cout << "Left Child of Node " <<
// logical_node.getOperationName() << " (" <<
// util::getName(log_algebra_ref.getColumnAlgebraOperation()) << ") is Invalid!"
//<< std::endl;
//			exit(-1);
//		}
//
...
// CPU_ColumnAlgebraOperation(sched_dec,
//																		left_child,
//																		right_child,
...
////
////		assert(right_child!=NULL); //binary operator
////		return ColumnWise_TypedOperatorPtr(new
/// GPU_ColumnAlgebraOperation(sched_dec,
////		                        left_child,
////
/// right_child,
//// log_algebra_ref.getColumnAlgebraOperation()
...
//		//std::cout << "calling map init function for
// CPU_ColumnAlgebraOperator operator!" << std::endl;
...
//                hype::AlgorithmSpecification
//                col_algebra_alg_spec_cpu("CPU_ColumnAlgebra_Algorithm",
//                        "CPU_ColumnAlgebra_Operator",
//                        hype::KNN_Regression,
//                        hype::Periodic);
//#else
//                hype::AlgorithmSpecification
...
//				hype::Scheduler::instance().addAlgorithm(col_algebra_alg_spec_cpu,dev_specs[i]);
...
//		}
//
//		map["CPU_ColumnAlgebra_Algorithm"]=create_CPU_ColumnAlgebraOperator;
//
//		return column_processing::cpu::Physical_Operator_Map_Ptr(new
// column_processing::cpu::Physical_Operator_Map(map));
//	}
//
