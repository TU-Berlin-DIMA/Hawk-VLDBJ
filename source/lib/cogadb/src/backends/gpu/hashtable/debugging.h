...
namespace CudaHT {
  namespace CuckooHashing {
     ...
     *  @param[in]  d_retrieval_probes  Device array: the number of probes taken
     * for each thread's retrieval.
     ...
     *  @param[in]  d_iterations_taken      Device mem: Number of iterations
     * each thread took.
     *  @param[in]  d_max_iterations_taken  Device mem: Largest number of
     * iterations taken by any thread.
     */
