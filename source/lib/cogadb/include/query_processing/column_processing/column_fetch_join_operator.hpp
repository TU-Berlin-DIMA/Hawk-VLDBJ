...
namespace CoGaDB {
  namespace query_processing {
    ...
    struct PK_FK_Join_Predicate {
      PK_FK_Join_Predicate(const std::string& join_pk_table_name_a,
    ...
    namespace physical_operator {
      ...
      class column_fetch_join_operator
          : public hype::queryprocessing::UnaryOperator<ColumnPtr, ColumnPtr>,
            public CoGaDB::query_processing::PositionListOperator {
       public:
        typedef column_processing::cpu::TypedOperatorPtr TypedOperatorPtr;
        column_fetch_join_operator(const hype::SchedulingDecision& sched_dec,
      ...
      create_column_fetch_join_operator(
    ...
    namespace logical_operator {
      ...
      class Logical_Column_Fetch_Join
          : public hype::queryprocessing::TypedNode_Impl<
                ColumnPtr,
                physical_operator::
                    map_init_function_column_fetch_join_operator>  // init_function_column_fetch_join_operator>
      // //init_function_column_fetch_join_operator>
      {
       public:
        Logical_Column_Fetch_Join(
