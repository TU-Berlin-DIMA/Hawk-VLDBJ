...
namespace CoGaDB {
  namespace query_processing {
    namespace physical_operator {
      ...
      class CPU_column_convert_bitmap_to_positionlist
      ...
      //            class GPU_column_convert_bitmap_to_positionlist : public
      //            hype::queryprocessing::UnaryOperator<ColumnPtr, ColumnPtr>,
      //            public PositionListOperator {
      //            public:
      //                typedef column_processing::cpu::TypedOperatorPtr
      //                TypedOperatorPtr;
      //                GPU_column_convert_bitmap_to_positionlist(const
    ...
    namespace logical_operator {
      ...
      class Logical_Column_Convert_Bitmap_To_PositionList
          : public hype::queryprocessing::TypedNode_Impl<
                ColumnPtr,
                physical_operator::
                    map_init_function_column_convert_bitmap_to_positionlist>  // init_function_column_convert_bitmap_to_positionlist> //init_function_column_convert_bitmap_to_positionlist>
      {
       public:
