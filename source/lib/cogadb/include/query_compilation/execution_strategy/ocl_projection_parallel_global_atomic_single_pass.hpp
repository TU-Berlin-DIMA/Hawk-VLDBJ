#ifndef OCL_PROJECTION_PARALLEL_GLOBAL_ATOMIC_SINGLE_PASS_HPP
#define OCL_PROJECTION_PARALLEL_GLOBAL_ATOMIC_SINGLE_PASS_HPP
...
namespace CoGaDB {
  namespace ExecutionStrategy {
    class OCLProjectionParallelGlobalAtomicSinglePass : public OCLProjection {
     public:
      OCLProjectionParallelGlobalAtomicSinglePass(
          bool use_host_ptr, MemoryAccessPattern mem_access,
          cl_device_id dev_id);
...
#endif  // OCL_PROJECTION_PARALLEL_GLOBAL_ATOMIC_SINGLE_PASS_HPP
