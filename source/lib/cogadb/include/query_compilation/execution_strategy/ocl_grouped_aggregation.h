#ifndef OCL_GROUPED_AGGREGATION_H
#define OCL_GROUPED_AGGREGATION_H
...
namespace CoGaDB {
  ...
  namespace ExecutionStrategy {
     ...
     * execution strategies that target grouped aggregation
     * pipelines
     */
    class OCLGroupedAggregation : public OCL {
     public:
      OCLGroupedAggregation(bool use_host_ptr, MemoryAccessPattern mem_access,
                            cl_device_id dev_id);
     ...
     private:
      ...
      /* \brief Tells wether this strategy should generate sequential,
