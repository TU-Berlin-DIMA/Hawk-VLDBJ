...
void _innerrec_init_copy(void *_dst, void *_src,
...
void func505_grad(const real_1d_array &x, double &func, real_1d_array &grad,
                  void *ptr) {
  double x0 = *((double *)ptr);

  //
  // This block assigns zero vector to gradient. Because gradient is a proxy
  // vector
  // (vector which uses another object as storage), sizes of gradient and vector
  // being
  // assigned must be equal. In this case data are copied in the memory linked
  // with
  // proxy.
  //
  // Early versions of ALGLIB failed to handle such assignment (it discrupted
  // link
  // between proxy vector and actual gradient stored in the internals of
  // ALGLIB).
  //
  real_1d_array z = "[0]";
  grad = "[0]";
  ...
  //
  // This block tries to perform operations which are forbidden for proxy
  // vector:
  // * assign vector of non-matching size
  // * change length of the vector
  // Correct implementation must throw an exception without breaking a link
  // between
...
void func505_jac(const real_1d_array &x, real_1d_array &fi, real_2d_array &jac,
                 void *ptr) {
  double x0 = *((double *)ptr);

  //
  // This block assigns zero matrix to Jacobian. Because Jacobian is a proxy
  // matrix
  // (matrix which uses another object as storage), sizes of Jacobian and matrix
  // being
  // assigned must be equal. In this case data are copied in the memory linked
  // with
  // proxy.
...
int main() {
  ...
  printf("Basic functions:\n");
  {
    ...
    try {
      ...
      // 1D boolean
      //
      // Default constructor, string constructor, copy constructor, assignment
      // constructors:
      // * test that array sizes as reported by length match to what was
      // specified
      ...
      //   (in this case distinct implementation is used which must be tested
      //   separately)
      //
      alglib::boolean_1d_array arr_0, arr_1("[]"), arr_2("[true,false,true]"),
          arr_3(arr_2), arr_4, arr_5;
      arr_4 = arr_2;
      ...
      passed = passed && (arr_2[0] == arr_2(0)) && (arr_2[1] == arr_2(1)) &&
               (arr_2[2] == arr_2(2));
      ...
      passed = passed && (arr_6[0] == a0[0]) && (arr_6[1] == a0[1]) &&
               (arr_6[2] == a0[2]) && (arr_6[3] == a0[3]) &&
               (arr_6[4] == a0[4]);
      p6 = arr_6.getcontent();
      passed = passed && (p6 != a0);
      passed = passed && (p6[0] == a0[0]) && (p6[1] == a0[1]) &&
               (p6[2] == a0[2]) && (p6[3] == a0[3]) && (p6[4] == a0[4]);
      a0[0] = a0_mod;
      ...
      // operations on constant arrays
      {
        ...
        passed = passed && (ac[0] == a0[0]) && (ac[1] == a0[1]) &&
                 (ac[2] == a0[2]) && (ac[3] == a0[3]) && (ac[4] == a0[4]);
        passed = passed && (ac(0) == a0[0]) && (ac(1) == a0[1]) &&
                 (ac(2) == a0[2]) && (ac(3) == a0[3]) && (ac(4) == a0[4]);
        const bool *p = ac.getcontent();
        passed = passed && (p[0] == a0[0]) && (p[1] == a0[1]) &&
                 (p[2] == a0[2]) && (p[3] == a0[3]) && (p[4] == a0[4]);
      }
      ...
      // * assignments to proxy are checked (their size must match to that of
      // the target)
      // * incorrect assignments or attempts to change length must generate
      // exception
      // * attempts to call setlength() must fail even when new size match
      // original size
      //   of the array
      //
    ...
    try {
      ...
      alglib::integer_1d_array arr_0, arr_1("[]"), arr_2(s1), arr_3(arr_2),
          arr_4, arr_5;
      arr_4 = arr_2;
      arr_5 = s2;
      passed = passed && (arr_0.length() == 0);
      ...
      passed = passed && (arr_2[0] == arr_2(0)) && (arr_2[1] == arr_2(1)) &&
               (arr_2[2] == arr_2(2));
      passed =
          passed && (arr_2[0] == v10) && (arr_2[1] == v11) && (arr_2[2] == v12);
      passed =
          passed && (arr_3[0] == v10) && (arr_3[1] == v11) && (arr_3[2] == v12);
      passed =
          passed && (arr_4[0] == v10) && (arr_4[1] == v11) && (arr_4[2] == v12);
      passed =
          passed && (arr_5[0] == v20) && (arr_5[1] == v21) && (arr_5[2] == v22);
      ...
      arr_2[0] = v10_mod;
      passed = passed && (arr_2[0] == v10_mod) && (arr_3[0] == v10) &&
               (arr_4[0] == v10);
      arr_5.setlength(99);
      passed = passed && (arr_5.length() == 99);
      ...
      proxy.attach_to(targt.c_ptr());
      acopy = proxy;
      passed = passed && (targt[0] == v30) && (targt[1] == v31) &&
               (targt[2] == v32) && (targt[3] == v33);
      passed = passed && (proxy[0] == v30) && (proxy[1] == v31) &&
               (proxy[2] == v32) && (proxy[3] == v33);
      passed = passed && (acopy[0] == v30) && (acopy[1] == v31) &&
               (acopy[2] == v32) && (acopy[3] == v33);

      targt[0] = v30_mod;
      passed = passed && (targt[0] == v30_mod) && (proxy[0] == v30_mod) &&
               (acopy[0] == v30);
      proxy[0] = v30;
      passed =
          passed && (targt[0] == v30) && (proxy[0] == v30) && (acopy[0] == v30);

      acopy = s4;
      proxy = acopy;
      passed = passed && (targt[0] == v40) && (targt[1] == v41) &&
               (targt[2] == v42) && (targt[3] == v43);
      passed = passed && (proxy[0] == v40) && (proxy[1] == v41) &&
               (proxy[2] == v42) && (proxy[3] == v43);
      proxy = s5;
      passed = passed && (targt[0] == v50) && (targt[1] == v51) &&
               (targt[2] == v52) && (targt[3] == v53);
      passed = passed && (proxy[0] == v50) && (proxy[1] == v51) &&
               (proxy[2] == v52) && (proxy[3] == v53);
    ...
    try {
      ...
      alglib::real_1d_array arr_0, arr_1("[]"), arr_2(s1), arr_3(arr_2), arr_4,
          arr_5;
      arr_4 = arr_2;
      arr_5 = s2;
      passed = passed && (arr_0.length() == 0);
    ...
    try {
      ...
      const char *s6 = "[7,7,7]";
      const int dps = 2;
      alglib::complex v10 = 2, v11 = alglib::complex(0, 3.5),
                      v12 = alglib::complex(1, -0.25), v10_mod = 9;
      ...
      alglib::complex_1d_array arr_0, arr_1("[]"), arr_2(s1), arr_3(arr_2),
          arr_4, arr_5;
      arr_4 = arr_2;
      arr_5 = s2;
      passed = passed && (arr_0.length() == 0);
...

  {
    ...
    try {
      ...
      const int dps = 2;
      double v10 = 2, v11 = 3.5, v12 = -0.25, v13 = 1, v14 = 2, v15 = 3,
             v10_mod = 9;
      double v20 = 5, v21 = 4, v22 = 3.126;
      /*double v30 =  6, v31 =  7, v32 =  3, v33 = -400, v30_mod = -6;
      double v40 =  9, v41 =  5, v42 =-12, v43 = -0.01;
      ...
      alglib::real_2d_array arr_0, arr_1("[[]]"), arr_2(s1), arr_3(arr_2),
          arr_4, arr_5;
      arr_4 = arr_2;
      arr_5 = s2;
      passed = passed && (arr_0.rows() == 0) && (arr_0.cols() == 0) &&
               (arr_0.getstride() == 0);
      passed = passed && (arr_1.rows() == 0) && (arr_1.cols() == 0) &&
               (arr_1.getstride() == 0);
      passed = passed && (arr_2.rows() == 2) && (arr_2.cols() == 3) &&
               (arr_2.getstride() >= arr_2.cols());
      passed = passed && (arr_3.rows() == 2) && (arr_3.cols() == 3) &&
               (arr_3.getstride() >= arr_3.cols());
      passed = passed && (arr_4.rows() == 2) && (arr_4.cols() == 3) &&
               (arr_4.getstride() >= arr_4.cols());
      passed = passed && (arr_5.rows() == 3) && (arr_5.cols() == 1) &&
               (arr_5.getstride() >= arr_5.cols());
      passed = passed && (arr_2[0][0] == arr_2(0, 0)) &&
               (arr_2[0][1] == arr_2(0, 1)) && (arr_2[0][2] == arr_2(0, 2));
      passed = passed && (arr_2[1][0] == arr_2(1, 0)) &&
               (arr_2[1][1] == arr_2(1, 1)) && (arr_2[1][2] == arr_2(1, 2));
      passed = passed && (arr_2[0][0] == v10) && (arr_2[0][1] == v11) &&
               (arr_2[0][2] == v12);
      passed = passed && (arr_2[1][0] == v13) && (arr_2[1][1] == v14) &&
               (arr_2[1][2] == v15);
      passed = passed && (arr_3[0][0] == v10) && (arr_3[0][1] == v11) &&
               (arr_3[0][2] == v12);
      passed = passed && (arr_3[1][0] == v13) && (arr_3[1][1] == v14) &&
               (arr_3[1][2] == v15);
      passed = passed && (arr_4[0][0] == v10) && (arr_4[0][1] == v11) &&
               (arr_4[0][2] == v12);
      passed = passed && (arr_4[1][0] == v13) && (arr_4[1][1] == v14) &&
               (arr_4[1][2] == v15);
      passed = passed && (arr_5[0][0] == v20) && (arr_5[1][0] == v21) &&
               (arr_5[2][0] == v22);
      passed = passed && (arr_2.tostring(dps) == s1_fmt);
      passed = passed && (arr_3.tostring(dps) == s1_fmt);
      passed = passed && (arr_4.tostring(dps) == s1_fmt);
      passed = passed && (arr_5.tostring(dps) == s2_fmt);
      arr_2[0][0] = v10_mod;
      passed = passed && (arr_2[0][0] == v10_mod) && (arr_3[0][0] == v10) &&
               (arr_4[0][0] == v10);
      ...
      for (n = 1; n <= 10; n++)
        for (m = 1; m <= 10; m++) {
          ...
          for (i = 0; i < m * n; i++) a0[i] = alglib::randomreal();
          ...
          // test that setcontent() actually copies data instead of creating
          // just reference
          r = a0[0];
          a0[0] = a0[0] + 1;
      ...
      r = targt[0][0];
      targt[0][0] = r + 1;
      passed = passed && (targt[0][0] != r) && (proxy[0][0] != r) &&
               (acopy[0][0] == r);
      proxy[0][0] = r;
      passed = passed && (targt[0][0] == r) && (proxy[0][0] == r) &&
               (acopy[0][0] == r);
...

  {
    ...
    try {
      ...
      try {
        ...
        read_csv("nonexistent123foralgtestinglib", '\t', alglib::CSV_DEFAULT,
                 arr);
        passed = false;
      ...
      try {
        ...
        remove(csv_name);
        passed =
            passed && arr.tostring(2) == "[[1.50,2.00,3.25],[4.00,5.00,6.00]]";
      } catch (...) {
        passed = false;
      }

      // header, tab-separated, mixed use of comma and full stop as decimal
      // points
      try {
        alglib::real_2d_array arr;
        file_put_contents(csv_name, "a\tb\tc\n1.5\t2\t3,25\n4\t5.25\t6,1\n");
        ...
        remove(csv_name);
        passed =
            passed && arr.tostring(2) == "[[1.50,2.00,3.25],[4.00,5.25,6.10]]";
      } catch (...) {
        passed = false;
      }

      // header, tab-separated, fixed/exponential, spaces, mixed use of comma
      // and full stop as decimal points
      try {
        alglib::real_2d_array arr;
        file_put_contents(csv_name,
                          " a\t b \tc\n1,1\t 2.9\t -3.5  \n  1.1E1  \t 2.0E-1 "
        ...
        passed = passed &&
                 arr.tostring(2) ==
                     "[[1.10,2.90,-3.50],[11.00,0.20,-30.00],[1.00,-2.00,3.00],"
                     "[0.10,-0.20,0.30]]";
      } catch (...) {
        passed = false;
      }
  ...
  {
    //
    // Testing issue #505 (http://bugs.alglib.net/view.php?id=505) in
    // optimizers.
    // This issue was present in ALL optimizers, but we test it only on two: CG
    // and LM.
    //
    try {
      //
    ...
    if (sizeof(alglib::ae_int_t) > 4) {
      ...
      try {
        ...
        //
        // nmax:
        // * first nmax is just large value to test basic uniformity of
        // generator
        //
        nmax[0] = 1000000;
...
#error AE_USE_ALLOC_COUNTER must be defined
    ...
    try {
      ...
      alglib_impl::ae_shared_pool_set_seed(
          &pool, &seed, sizeof(seed), _seedrec_init, _seedrec_init_copy,
          _seedrec_destroy, &_alglib_env_state);
      alglib_impl::ae_state_clear(&_alglib_env_state);
      issue528_passed =
          issue528_passed && (alloc_cnt == alglib_impl::_alloc_counter);
    ...
    try {
      ...
      issue591_passed = issue591_passed && (fabs(y0[0] - y1[0]) < 1.0E-9) &&
                        (fabs(y0[1] - y1[1]) < 1.0E-9);
      ...
      issue591_passed = issue591_passed && (fabs(y0[0] - y2[0]) < 1.0E-9) &&
                        (fabs(y0[1] - y2[1]) < 1.0E-9);
    } catch (...) {
      issue591_passed = false;
    }
    printf(fmt_str, "* issue 591", issue591_passed ? "OK" : "FAILED");
    fflush(stdout);
    if (!issue591_passed) return 1;
    ...
    try {
      ...
      alglib::mlpprocess(net1, x, y1);
      alglib::mlpprocess(net2, x, y2);
      issue594_passed = issue594_passed && (fabs(y0[0] - y1[0]) < 1.0E-9) &&
                        (fabs(y0[1] - y1[1]) < 1.0E-9);
      issue594_passed = issue594_passed && (fabs(y0[0] - y2[0]) < 1.0E-9) &&
                        (fabs(y0[1] - y2[1]) < 1.0E-9);
    } catch (...) {
  ...
  {
    {
      ...
      for (nidx = 0; _n[nidx] != 0; nidx++) {
        ...
        for (k = 0; k < nrepeat; k++)
          alglib::rmatrixgemm(n, n, n, 1.0, a, 0, 0, k % 2, b, 0, 0,
                              (k / 2) % 2, 0.0, c, 0, 0);
        ...
        t = alglib_impl::_tickcount();
        for (k = 0; k < nrepeat; k++)
          alglib::smp_rmatrixgemm(n, n, n, 1.0, a, 0, 0, k % 2, b, 0, 0,
                                  (k / 2) % 2, 0.0, c, 0, 0);
        t = alglib_impl::_tickcount() - t;
