...
namespace alglib_impl {
  ...
  typedef struct { double maxerr; } polynomialsolverreport;
}
...
namespace alglib {
  ...
  *************************************************************************/
  void cmatrixlusolvem(const complex_2d_array &lua, const integer_1d_array &p,
                       ...
                       const ae_int_t m, ae_int_t &info, densesolverreport &rep,
                       complex_2d_array &x);
  void smp_cmatrixlusolvem(const complex_2d_array &lua,
                           const integer_1d_array &p, const ae_int_t n,
                           const complex_2d_array &b, const ae_int_t m,
                           ae_int_t &info, densesolverreport &rep,
                           complex_2d_array &x);
  ...
  *************************************************************************/
  void spdmatrixcholeskysolvemfast(const real_2d_array &cha, const ae_int_t n,
                                   const bool isupper, const real_2d_array &b,
                                   const ae_int_t m, ae_int_t &info);
  void smp_spdmatrixcholeskysolvemfast(const real_2d_array &cha,
  ...
  *************************************************************************/
  void hpdmatrixcholeskysolvem(const complex_2d_array &cha, const ae_int_t n,
                               ...
                               const ae_int_t m, ae_int_t &info,
                               densesolverreport &rep, complex_2d_array &x);
  void smp_hpdmatrixcholeskysolvem(const complex_2d_array &cha,
                                   const ae_int_t n, const bool isupper,
                                   const complex_2d_array &b, const ae_int_t m,
                                   ae_int_t &info, densesolverreport &rep,
                                   complex_2d_array &x);
  ...
  *************************************************************************/
  ...
  OUTPUT PARAMETERS:
    ...
    -- ALGLIB --
       Copyright 14.11.2011 by Bochkanov Sergey
  *************************************************************************/
  void lincgresults(const lincgstate &state, real_1d_array &x,
                    lincgreport &rep);
  ...
  *************************************************************************/
  ...
  where array reallocation penalty is too large to be ignored.
    ...
    -- ALGLIB --
       Copyright 20.08.2009 by Bochkanov Sergey
  *************************************************************************/
  void nleqresultsbuf(const nleqstate &state, real_1d_array &x,
                      nleqreport &rep);
...
namespace alglib_impl {
  ...
  void _pexec_spdmatrixsolve(/* Real    */ ae_matrix *a, ae_int_t n,
                             ...
                             densesolverreport *rep,
                             /* Real    */ ae_vector *x, ae_state *_state);
  void spdmatrixsolvefast(/* Real    */ ae_matrix *a, ae_int_t n,
                          ae_bool isupper,
                          /* Real    */ ae_vector *b, ae_int_t *info,
                          ae_state *_state);
  ...
  void _pexec_hpdmatrixsolve(/* Complex */ ae_matrix *a, ae_int_t n,
                             ...
                             densesolverreport *rep,
                             /* Complex */ ae_vector *x, ae_state *_state);
  void hpdmatrixsolvefast(/* Complex */ ae_matrix *a, ae_int_t n,
                          ae_bool isupper,
                          /* Complex */ ae_vector *b, ae_int_t *info,
                          ae_state *_state);
  ...
  void hpdmatrixcholeskysolvefast(/* Complex */ ae_matrix *cha, ae_int_t n,
                                  ...
                                  /* Complex */ ae_vector *b, ae_int_t *info,
                                  ae_state *_state);
  void rmatrixsolvels(/* Real    */ ae_matrix *a, ae_int_t nrows,
                      ae_int_t ncols,
