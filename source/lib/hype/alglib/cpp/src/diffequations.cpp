...
_odesolverstate_owner::_odesolverstate_owner() {
  p_struct = (alglib_impl::odesolverstate *)alglib_impl::ae_malloc(
      sizeof(alglib_impl::odesolverstate), NULL);
...
_odesolverstate_owner::_odesolverstate_owner(const _odesolverstate_owner &rhs) {
  ...
  alglib_impl::_odesolverstate_init_copy(
      p_struct, const_cast<alglib_impl::odesolverstate *>(rhs.p_struct), NULL);
}
...
_odesolverreport_owner::_odesolverreport_owner() {
  p_struct = (alglib_impl::odesolverreport *)alglib_impl::ae_malloc(
      sizeof(alglib_impl::odesolverreport), NULL);
  if (p_struct == NULL) throw ap_error("ALGLIB: malloc error");
...
_odesolverreport_owner::_odesolverreport_owner(
  ...
  alglib_impl::_odesolverreport_init_copy(
      p_struct, const_cast<alglib_impl::odesolverreport *>(rhs.p_struct), NULL);
}
...
lbl_10:
  ...
  for (j = 0; j <= n - 1; j++) {
    if (!state->fraceps) {
       ...
       */
      err = ae_maxreal(
          err, ae_fabs(state->yn.ptr.p_double[j] - state->yns.ptr.p_double[j],
                       _state),
          _state);
    } else {
      /*
