...
#define ae_false false
  ...
  ************************************************************************/
  ...
  frame marker
  ************************************************************************/
  typedef struct ae_frame { ae_dyn_block db_marker; } ae_frame;
 ...
 */
  ...
  ************************************************************************/
  ...
  typedef struct ae_smart_ptr {
    ...
    /* whether object pointed by ptr is dynamic - clearing such object requires
       BOTH
       calling destructor function AND calling ae_free for memory occupied by
       object. */
    ae_bool is_dynamic;
  ...
  ************************************************************************/
  ...
  void ae_v_cmoved(ae_complex *vdst, ae_int_t stride_dst,
                   const ae_complex *vsrc, ae_int_t stride_src,
                   const char *conj_src, ae_int_t n, double alpha);
  void ae_v_cmovec(ae_complex *vdst, ae_int_t stride_dst,
                   const ae_complex *vsrc, ae_int_t stride_src,
...
#define ae_pi 3.1415926535897932384626433832795
  ...
  ************************************************************************/
  ...
  void _rcommstate_init_copy(rcommstate *dst, rcommstate *src,
                             ae_state *_state);
...
namespace alglib {
  ...
  ********************************************************************/
  ...
  const alglib::complex operator+(const alglib::complex &lhs,
                                  const double &rhs);
  const alglib::complex operator+(const double &lhs,
                                  const alglib::complex &rhs);
  const alglib::complex operator-(const alglib::complex &lhs,
                                  const alglib::complex &rhs);
  const alglib::complex operator-(const alglib::complex &lhs,
  ...
  ********************************************************************/
  ...
  class ae_matrix_wrapper {
   public:
    ...
    void allocate_own(ae_int_t rows, ae_int_t cols,
  ...
  ********************************************************************/
  ...
  {
  public:
      dataset():nin(0), nout(0), nclasses(0), trnsize(0), valsize(0),
  tstsize(0), totalsize(0){};
...
#define ALGLIB_INTERCEPTS_ABLAS
  ...
  void _ialglib_mcopyunblock(ae_int_t m, ae_int_t n, const double *a,
                             ae_int_t op, double *b, ae_int_t stride);
  ...
  ae_bool _ialglib_i_cmatrixrighttrsmf(ae_int_t m, ae_int_t n, ae_matrix *a,
                                       ae_int_t i1, ae_int_t j1,
                                       ae_bool isupper, ae_bool isunit,
                                       ae_int_t optype, ae_matrix *x,
                                       ae_int_t i2, ae_int_t j2);
