...
double pearsoncorr2(const real_1d_array &x, const real_1d_array &y) {
  ...
  if ((x.length() != y.length()))
    throw ap_error(
        "Error while calling 'pearsoncorr2': looks like one of arguments has "
        "wrong size");
  n = x.length();
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
...
double spearmancorr2(const real_1d_array &x, const real_1d_array &y) {
  ...
  if ((x.length() != y.length()))
    throw ap_error(
        "Error while calling 'spearmancorr2': looks like one of arguments has "
        "wrong size");
  n = x.length();
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
...
void smp_covm(const real_2d_array &x, const ae_int_t n, const ae_int_t m,
              real_2d_array &c) {
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
    alglib_impl::_pexec_covm(const_cast<alglib_impl::ae_matrix *>(x.c_ptr()), n,
...
void smp_pearsoncorrm(const real_2d_array &x, const ae_int_t n,
                      const ae_int_t m, real_2d_array &c) {
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
    alglib_impl::_pexec_pearsoncorrm(
        const_cast<alglib_impl::ae_matrix *>(x.c_ptr()), n, m,
        const_cast<alglib_impl::ae_matrix *>(c.c_ptr()), &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return;
...
void smp_spearmancorrm(const real_2d_array &x, const ae_int_t n,
                       const ae_int_t m, real_2d_array &c) {
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
    alglib_impl::_pexec_spearmancorrm(
        const_cast<alglib_impl::ae_matrix *>(x.c_ptr()), n, m,
        const_cast<alglib_impl::ae_matrix *>(c.c_ptr()), &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return;
...
void smp_covm2(const real_2d_array &x, const real_2d_array &y, const ae_int_t n,
               const ae_int_t m1, const ae_int_t m2, real_2d_array &c) {
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
    alglib_impl::_pexec_covm2(
...
void covm2(const real_2d_array &x, const real_2d_array &y, real_2d_array &c) {
  ...
  if ((x.rows() != y.rows()))
    throw ap_error(
        "Error while calling 'covm2': looks like one of arguments has wrong "
        "size");
  n = x.rows();
  m1 = x.cols();
  m2 = y.cols();
...
void smp_covm2(const real_2d_array &x, const real_2d_array &y,
               real_2d_array &c) {
  alglib_impl::ae_state _alglib_env_state;
  ae_int_t n;
  ae_int_t m1;
...
void smp_pearsoncorrm2(const real_2d_array &x, const real_2d_array &y,
                       const ae_int_t n, const ae_int_t m1, const ae_int_t m2,
                       real_2d_array &c) {
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
    alglib_impl::_pexec_pearsoncorrm2(
        const_cast<alglib_impl::ae_matrix *>(x.c_ptr()),
        const_cast<alglib_impl::ae_matrix *>(y.c_ptr()), n, m1, m2,
        const_cast<alglib_impl::ae_matrix *>(c.c_ptr()), &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
...
void pearsoncorrm2(const real_2d_array &x, const real_2d_array &y,
  ...
  if ((x.rows() != y.rows()))
    throw ap_error(
        "Error while calling 'pearsoncorrm2': looks like one of arguments has "
        "wrong size");
  n = x.rows();
  m1 = x.cols();
  m2 = y.cols();
...
void smp_spearmancorrm2(const real_2d_array &x, const real_2d_array &y,
                        const ae_int_t n, const ae_int_t m1, const ae_int_t m2,
                        real_2d_array &c) {
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
    alglib_impl::_pexec_spearmancorrm2(
        const_cast<alglib_impl::ae_matrix *>(x.c_ptr()),
        const_cast<alglib_impl::ae_matrix *>(y.c_ptr()), n, m1, m2,
        const_cast<alglib_impl::ae_matrix *>(c.c_ptr()), &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
...
void spearmancorrm2(const real_2d_array &x, const real_2d_array &y,
  ...
  if ((x.rows() != y.rows()))
    throw ap_error(
        "Error while calling 'spearmancorrm2': looks like one of arguments has "
        "wrong size");
  n = x.rows();
  m1 = x.cols();
  m2 = y.cols();
...
void smp_rankdata(const real_2d_array &xy, const ae_int_t npoints,
                  const ae_int_t nfeatures) {
  alglib_impl::ae_state _alglib_env_state;
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
    alglib_impl::_pexec_rankdata(
...
void smp_rankdatacentered(const real_2d_array &xy, const ae_int_t npoints,
  ...
  alglib_impl::ae_state_init(&_alglib_env_state);
  try {
    alglib_impl::_pexec_rankdatacentered(
        const_cast<alglib_impl::ae_matrix *>(xy.c_ptr()), npoints, nfeatures,
        &_alglib_env_state);
    alglib_impl::ae_state_clear(&_alglib_env_state);
    return;
...
*************************************************************************/
void _pexec_covm(/* Real    */ ae_matrix *x, ae_int_t n, ae_int_t m,
                 /* Real    */ ae_matrix *c, ae_state *_state) {
  covm(x, n, m, c, _state);
}
...
Single-threaded stub. HPC ALGLIB replaces it by multithreaded code.
*************************************************************************/
void _pexec_pearsoncorrm(/* Real    */ ae_matrix *x, ae_int_t n, ae_int_t m,
                         /* Real    */ ae_matrix *c, ae_state *_state) {
...
Single-threaded stub. HPC ALGLIB replaces it by multithreaded code.
*************************************************************************/
void _pexec_spearmancorrm(/* Real    */ ae_matrix *x, ae_int_t n, ae_int_t m,
                          /* Real    */ ae_matrix *c, ae_state *_state) {
...
void rankdata(/* Real    */ ae_matrix *xy, ae_int_t npoints, ae_int_t nfeatures,
   ...
   */
  if (ae_fp_less(inttoreal(npoints, _state) * inttoreal(nfeatures, _state) *
...
Single-threaded stub. HPC ALGLIB replaces it by multithreaded code.
*************************************************************************/
void _pexec_rankdata(/* Real    */ ae_matrix *xy, ae_int_t npoints,
...
Single-threaded stub. HPC ALGLIB replaces it by multithreaded code.
*************************************************************************/
void _pexec_rankdatacentered(/* Real    */ ae_matrix *xy, ae_int_t npoints,
                             ae_int_t nfeatures, ae_state *_state) {
...
static void basestat_rankdatarec(/* Real    */ ae_matrix *xy, ae_int_t i0,
   ...
   */
  problemcost = inttoreal(i1 - i0, _state) * inttoreal(nfeatures, _state) *
                logbase2((double)(nfeatures), _state);
...
static double jarquebera_jarqueberaapprox(ae_int_t n, double s,
  ...
  if (n > 1401) {
    result = -0.5 * x +
             (jarquebera_jbtbl1401(x, _state) + 0.5 * x) *
...
void mannwhitneyutest(/* Real    */ ae_vector *x, ae_int_t n,
  ...
  *bothtails =
      boundval(ae_maxreal(2 * ae_minreal(p, mp, _state), 1.0E-4, _state),
               0.0001, 0.2500, _state);
...
void unequalvariancettest(/* Real    */ ae_vector *x, ae_int_t n,
  ...
  *righttail = 0;
  ...
  if (ae_fp_greater(stat, (double)(0))) {
    p = 1 -
        0.5 * incompletebeta(df / 2, 0.5, df / (df + ae_sqr(stat, _state)),
                             _state);
  } else {
    p = 0.5 *
