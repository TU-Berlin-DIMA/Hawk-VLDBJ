...
namespace alglib {
  ...
  *************************************************************************/
  void samplepercentile(const real_1d_array &x, const ae_int_t n,
  ...
  *************************************************************************/
  ...
  void smp_spearmancorrm2(const real_2d_array &x, const real_2d_array &y,
                          const ae_int_t n, const ae_int_t m1,
  ...
  *************************************************************************/
  ...
  NOTE: this function correctly handles degenerate cases:
    ...
    -- ALGLIB --
       Copyright 08.09.2006 by Bochkanov Sergey
  *************************************************************************/
  void studentttest1(const real_1d_array &x, const ae_int_t n,
                     const double mean, double &bothtails, double &lefttail,
                     double &righttail);
...
namespace alglib_impl {
  ...
  void _pexec_spearmancorrm2(/* Real    */ ae_matrix *x,
                             ...
                             ae_int_t m1, ae_int_t m2,
                             /* Real    */ ae_matrix *c, ae_state *_state);
  void rankdata(/* Real    */ ae_matrix *xy, ae_int_t npoints,
  ...
  void onesamplevariancetest(/* Real    */ ae_vector *x, ae_int_t n,
                             double variance, double *bothtails,
                             double *lefttail, double *righttail,
                             ae_state *_state);
