...
set ylabel 'Copy Time Host Device in seconds'
...
set output "copy_time_host_device..pdf"
...
plot 'false-false-false-measurements.csv' using ($1):8 title 'No DDP, No QC, No Pull' w lp lw 6 pt 6 ps 1.5 lc rgb 'black', \
'false-true-false-measurements.csv' using ($1):8 title 'No DDP, QC, No Pull' w lp lw 6 ps 1.5 lc rgb 'gray70', \
'true-false-false-measurements.csv' using ($1):8 title 'DDP, No QC, No Pull' w lp lw 6 pt 8 ps 1.5 lc rgb 'gray50', \
'false-true-true-measurements.csv' using ($1):8 title 'No DDP, QC, Pull' w lp lw 6 ps 1.5 lc rgb 'gray70', \
'true-true-true-measurements.csv' using ($1):8 title 'DDP, QC, Pull' w lp lw 6 ps 1.5 lc rgb 'gray70'
