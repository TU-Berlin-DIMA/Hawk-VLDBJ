...
set ylabel 'Number of Evicted Columns from Cache'
...
set output "column_evictions_from_cache.pdf"
...
plot 'false-false-false-measurements.csv' using ($1):14 title 'No DDP, No QC, No Pull' w lp lw 6 pt 6 ps 1.5 lc rgb 'black', \
'false-true-false-measurements.csv' using ($1):14 title 'No DDP, QC, No Pull' w lp lw 6 ps 1.5 lc rgb 'gray70', \
'true-false-false-measurements.csv' using ($1):14 title 'DDP, No QC, No Pull' w lp lw 6 pt 8 ps 1.5 lc rgb 'gray50', \
'false-true-true-measurements.csv' using ($1):14 title 'No DDP, QC, Pull' w lp lw 6 ps 1.5 lc rgb 'gray70', \
'true-true-true-measurements.csv' using ($1):14 title 'DDP, QC, Pull' w lp lw 6 ps 1.5 lc rgb 'gray70'
