...
set ylabel 'Copy Time Device Host in seconds'
...
set output "copy_time_device_host.pdf"
...
plot 'false-false-false-measurements.csv' using ($1):9 title 'No DDP, No QC, No Pull' w lp lw 6 pt 6 ps 1.5 lc rgb 'black', \
'false-true-false-measurements.csv' using ($1):9 title 'No DDP, QC, No Pull' w lp lw 6 ps 1.5 lc rgb 'gray70', \
'true-false-false-measurements.csv' using ($1):9 title 'DDP, No QC, No Pull' w lp lw 6 pt 8 ps 1.5 lc rgb 'gray50', \
'false-true-true-measurements.csv' using ($1):9 title 'No DDP, QC, Pull' w lp lw 6 ps 1.5 lc rgb 'gray70', \
'true-true-true-measurements.csv' using ($1):9 title 'DDP, QC, Pull' w lp lw 6 ps 1.5 lc rgb 'gray70'
